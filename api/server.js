...
// 🔧 CRITICAL FIX: Hardcode your live Razorpay keys for immediate testing
process.env.TEDX_RAZORPAY_KEY_ID = "rzp_live_RAdCru2UL8q5u1";
process.env.TEDX_RAZORPAY_KEY_SECRET = "5CJyrY6gq2hcbZiOrQ5aLX5N";
...
async function verifyRazorpayConfig() {
  try {
    ...
    try {
      ...
      // Don't fail in development, but log the issue
      if (NODE_ENV === "production") {
        throw testErr;
      }
    }
